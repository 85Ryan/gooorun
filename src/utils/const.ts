// const
const MAPBOX_TOKEN =
  'pk.eyJ1IjoibHhsMnJ5YW4iLCJhIjoiY2xxOTVjN2l3MW5kcDJpcW1mNWZyaDdnaiJ9.pETWpQMo6xha9hQbGj8qHw';
...
const CHINESE_INFO_MESSAGE = (yearLength: number): string => {
  return `这是我坚持跑步的第 ${yearLength} 年...因为热爱，所以坚持...`;
};
